...
@section('midsection')
					...
					<div class="container">
						<div class="banner-info_agile_w3ls">
							...
							<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
								laudantium</p>
							<a href="{{url('/about')}}" class="button-w3ls active mt-5">Read More
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-7 col-md-6 about-right-w3 text-right py-md-5">
				<div class="right-space py-xl-5 py-lg-3">
					...
					<a href="{{url('/about')}}" class="button-w3ls mt-5">Read More
						<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
					</a>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="{{url('/menu')}}">
								<img class="card-img-bottom" src="{{url('website/images/blog1.jpg')}}" alt="Card image cap">
							</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="{{url('/menu')}}">
								<img class="card-img-bottom" src="{{url('website/images/blog2.jpg')}}" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-0">
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="{{url('/menu')}}">
								<img class="card-img-bottom" src="{{url('website/images/blog3.jpg')}}" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-0">
	...
	<section class="middle py-5" id="services">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row grids-w3 py-xl-5 py-lg-4 pt-lg-0 pt-4">
				<div class="col-lg-5 w3pvt-lauits_banner_bottom_left">
					<div class="row">
						<div class="col-8 wthree_banner_bottom_grid_right text-right">
							<h4 class="mb-3"><a href="{{url('/login')}}">Free Shipping</a></h4>
						...
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center">
							<img src="{{url('website/images/s1.png')}}" alt="" class="img-fluid">
						</div>
					</div>
				</div>
				...
				<div class="col-lg-5 w3pvt-lauits_banner_bottom_left mt-lg-0 mt-4">
					<div class="row">
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center">
							<img src="{{url('website/images/s2.png')}}" alt="" class="img-fluid">
						</div>
						<div class="col-8 wthree_banner_bottom_grid_right">
							<h4 class="mb-3"><a href="{{url('/login')}}">Free & Easy Returns</a></h4>
							<p>Morbi viverra lacus commodo felis semper lectus feugiat.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 w3pvt-lauits_banner_bottom_left">
					<div class="row">
						<div class="col-8 wthree_banner_bottom_grid_right text-right pl-lg-0">
							<h4 class="mb-3"><a href="{{url('/login')}}">Online Order</a></h4>
							<p>Morbi viverra lacus commodo felis semper lectus feugiat.</p>
						</div>
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center pr-lg-0">
							<img src="{{url('website/images/s3.png')}}" alt="" class="img-fluid">
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 w3pvt-lauits_banner_bottom_left mt-lg-0 mt-4">
					<div class="row">
						<div class="col-4 wthree_banner_bottom_grid_left text-lg-right text-center pl-lg-0">
							<img src="{{url('website/images/s4.png')}}" alt="" class="img-fluid">
						</div>
						<div class="col-8 wthree_banner_bottom_grid_right pr-lg-0">
							<h4 class="mb-3"><a href="{{url('/login')}}">24/7 Support</a></h4>
							<p>Morbi viverra lacus commodo felis semper lectus feugiat.</p>
						</div>
					</div>
				</div>
		...
		<div class="img-blog-2">
			<img src="{{url('website/images/img.png')}}" alt="" class="img-fluid">
		</div>
	</section>
	<!-- //services -->
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="{{url('/single')}}">
								<img src="{{url('website/images/blog1.png')}}" class="card-img-bottom img-fluid" alt="image">
							</a>
							<img src="{{url('website/images/te1.jpg')}}" alt="" class="img-blog rounded-circle img-fluid">
						</div>
						<div class="card-body text-center pt-5 mt-2">
							<h5 class="blog-title card-title mb-2"><a href="{{url('/single')}}">Sed ut Riciatis</a></h5>
							...
							<a href="{{url('/single')}}" class="button-w3ls mt-4">Read More
								<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
							</a>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="{{url('/single')}}">
								<img src="{{url('website/images/blog2.png')}}" class="card-img-bottom img-fluid" alt="image">
							</a>
							<img src="{{url('website/images/te2.jpg')}}" alt="" class="img-blog rounded-circle img-fluid">
						</div>
						<div class="card-body text-center pt-5 mt-2">
							<h5 class="blog-title card-title mb-2"><a href="{{url('/single')}}">Unde omnis iste</a></h5>
							<div class="blog_w3icon border-top border-bottom py-1 mb-3">
								<span>
									Auris Jlan - Nov 15</span>
							</div>
							<p>Cras ultricies ligula sed magna dictum porta auris blandita.</p>
							<a href="{{url('/single')}}" class="button-w3ls active mt-4">Read More
								<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
							</a>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
					<div class="card border-0">
						<div class="card-header p-0">
							<a href="{{url('/single')}}">
								<img src="{{url('website/images/blog3.png')}}" class="card-img-bottom img-fluid" alt="image">
							</a>
							<img src="{{url('website/images/te3.jpg')}}" alt="" class="img-blog rounded-circle img-fluid">
						</div>
						<div class="card-body text-center pt-5 mt-2">
							<h5 class="blog-title card-title mb-2"><a href="{{url('/single')}}">Natus error sit</a></h5>
							<div class="blog_w3icon border-top border-bottom py-1 mb-3">
								<span>
	...
	<section class="subscribe-main py-5">
		<div class="container py-xl-5 py-3">
			...
			<img src="{{url('website/images/sub.png')}}" alt="" class="img-fluid sub-img">
		</div>
	</section>
	<!-- //newsletter -->
@endsection