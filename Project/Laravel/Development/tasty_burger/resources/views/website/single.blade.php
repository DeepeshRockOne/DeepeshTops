				...
				<div class="row">
					...
					<div class="col-lg-8 left-blog-info text-left">
						<div class="blog-grid-top">
							<div class="b-grid-top">
								<div class="blog_info_left_grid">
									<a href="{{url('/single')}}">
										<img src="{{url('website/images/single1.jpg')}}')}}" class="img-fluid" alt="">
									</a>
								</div>
							</div>

							<h3>
								<a href="{{url('/single')}}" class="single-text text-da font-weight-light">Nemo enim ipsam
						...
						<div class="comment-top">
							<h4>Comments</h4>
							<div class="media">
								<img src="{{url('website/images/te3.jpg')}}')}}" alt="" class="img-fluid" />
							...
							<div class="media mt-3">
								<a class="d-flex pr-3" href="#">
									<img src="{{url('website/images/te2.jpg')}}')}}" alt="" class="img-fluid" />
								</a>
								<div class="media-body">
					...
					<aside class="col-lg-4 right-blog-con text-right mt-lg-0 mt-5">
						<div class="right-blog-info text-left">
							...
							<div class="tech-btm">
								<img src="{{url('website/images/blog1.jpg')}}" class="img-fluid" alt="">
							</div>
							<div class="tech-btm">
								<h4>Categories</h4>
							...
							<div class="tech-btm">
								...
								<div class="blog-grids row mb-3">
									...
									<div class="col-md-7 blog-grid-right mt-2">
										<h5>
											<a href="{{url('/single')}}">Pellentesque dui, non felis. Maecenas male non felis
											</a>
										</h5>
										<div class="sub-meta">
											<span>
								...
								<div class="blog-grids row mb-2">
									<div class="col-md-5 blog-grid-left">
										<a href="{{url('/single')}}">
											<img src="{{url('website/images/blog2.jpg')}}" class="img-fluid" alt="">
										</a>
									</div>
							...
							<div class="single-gd tech-btm">
								...
								<div class="blog-grids">
									<div class="blog-grid-left">
										<a href="{{url('/single')}}">
											<img src="{{url('website/images/blog1.png')}}" class="img-fluid" alt="">
										</a>
									</div>
									<div class="blog-grid-right">
										<h5 class="mt-0">
											<a href="{{url('/single')}}">Pellentesque dui, non felis. Maecenas male</a>
										</h5>
									</div>
