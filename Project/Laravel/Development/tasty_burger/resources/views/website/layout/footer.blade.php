		...
		<div class="container py-xl-4">
			<div class="row footer-top">
				<div class="col-lg-4 footer-grid_section_1its footer-text">
					<!-- logo -->
					<h2>
						<a class="logo text-wh" href="{{url('/index')}}">
				...
				<div class="col-lg-4 footer-grid_section_1its my-lg-0 my-sm-4 my-4">
					...
					<ul class="list-unstyled payment-links mt-4">
						<li>
							<a href="{{url('/login')}}"><img src="{{url('website/images/pay2.png')}}" alt=""></a>
						</li>
						<li>
							<a href="{{url('/login')}}"><img src="{{url('website/images/pay5.png')}}" alt=""></a>
						</li>
						<li>
							<a href="{{url('/login')}}"><img src="{{url('website/images/pay1.png')}}" alt=""></a>
						</li>
						<li>
							<a href="{{url('/login')}}"><img src="{{url('website/images/pay4.png')}}" alt=""></a>
						</li>
					</ul>
				</div>
