        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{url('/admin_dashboard')}}">Admin</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="{{url('/admin_dashboard')}}"><i class="fa fa-home fa-fw"></i> Website</a></li>
                </ul>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="{{url('/admin_login')}}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{url('/admin_login')}}">Login Page</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
